export const testData = [
  ...
  },
  {
    id: '3',
    description:
      'When the user tries to delete the element from the empty stack then the condition is said to be a __',
    option: [
      'Underflow',
      'Garbage Collection',
      'Overflow',
  ...
  {
    id: '5',
    description: 'Which of the following is the prefix form of A+B*C?',
  ...
  {
    id: '15',
    description: 'What is time complexity of binary search?',
    option: ['O(1)', 'O(n)', 'O(logn)', 'O(nlogn)'],
    answer: 'O(logn)',
  ...
  {
    id: '17',
    description: 'The complexity of Bubble sort algorithm is',
  ...
  {
    id: '18',
    description: 'In linear search algorithm the Worst case occurs when',
    option: [
  ...
  {
    id: '23',
    description: 'Which of the following principle does Queue use?',
    option: [
      'LIFO principle',
      'FIFO principle',
      'Linear tree',
  ...
  {
    id: '24',
    description: 'Which one of the following is not the type of the Queue',
    option: [
      'Linear Queue',
      'Circular Queue',
      'Double ended Queue',
  ...
  {
    id: '25',
    description: 'The time complexity of enqueue operation in Queue is __',
    option: ['O(1)', 'O(n)', 'O(logn)', 'O(nlogn)'],
    answer: 'O(1)',
    tags: ['queue', 'easy'],
    total_submission: 0,
  ...
  },
  {
    ...
    answer: '(rear+1) % max',
    tags: ['queue', 'circular queue', 'hard'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 2,
    link: 'https://www.javatpoint.com/data-structure-mcq',
  },
  {
    id: '27',
    description:
      'n the linked list implementation of queue, where will the new element be inserted?',
    option: [
  ...
  {
    id: '28',
    description: 'How many Queues are required to implement a Stack?',
    option: ['3', '2', '1', '4'],
    answer: '2',
  ...
  },
  {
    ...
    answer: 'Heap',
    tags: ['queue', 'priority queue', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link: 'https://www.javatpoint.com/data-structure-mcq',
  },
  {
    ...
    option: ['Queue', 'Deque', 'Priority queue', 'Circular queue'],
    answer: 'Deque',
    tags: ['Queue', 'easy'],
    total_submission: 0,
    correct_submission: 0,
  ...
  {
    id: '31',
    description: 'How can we define a AVL tree?',
    option: [
  ...
  },
  {
    ...
    option: ['Multi Graph', 'Regular Graph', 'Simple Graph', 'Complete Graph'],
  ...
  },
  {
    ...
    option: ['x=5, y=3', 'x=3, y=5', ' x=3, y=3', 'x=5, y=5'],
    answer: 'x=5, y=3',
    tags: ['graph', 'easy'],
    total_submission: 0,
    correct_submission: 0,
  ...
  },
  {
    ...
    option: ['True', 'False', 'Insufficient information', 'Both b and c'],
    answer: 'False',
  ...
  },
  {
    ...
    option: ['Merge ', 'Heap', 'Selection', 'Bubble'],
    answer: 'Selection',
    tags: ['sorting', 'selection sort', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
  ...
  {
    id: '43',
    description: 'The Average case occurs in the linear search algorithm ……….',
    option: [
  ...
  {
    id: '44',
    description: 'The complexity of merge sort algorithm is ……',
    option: ['O(n)', 'O(logn)', 'O(n2)', 'O(n logn)'],
    answer: 'O(n logn)',
    tags: ['sorting', 'easy', 'merge sort'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
  ...
  },
  {
    ...
    option: ['Insertion', 'Extraction', 'Selection', 'Distribution'],
    answer: 'Insertion',
    tags: ['sorting', 'medium', 'insertion sort'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link:
  ...
  {
    id: '46',
    description: '………… is the method used by card sorter.',
    option: ['Radix sort', 'Insertion', 'Heap', 'Quick'],
    answer: 'Radix sort',
    tags: ['sorting', 'easy'],
    total_submission: 0,
    correct_submission: 0,
  ...
  },
  {
    ...
    option: ['Bubble sort', 'Insertion sort', 'Merge sort', 'Selection sort'],
    answer: 'Selection sort',
    tags: ['priority queue', 'queue', 'medium', 'selection sort'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
  ...
  {
    id: '49',
    description: 'Partition and exchange sort is ……..',
    option: ['quick sort', 'tree sort', 'heap sort', 'bubble sort'],
    answer: 'quick sort',
    tags: ['sorting', 'quick sort', 'medium'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link:
  ...
  {
    id: '50',
    description: ' An un weighted, connected or disconnected is a ____',
    option: [
      'weighted graph',
      'unweighted graph',
      'simple graph',
  ...
  },
  {
    id: '51',
    description:
      'Which of the following means computing the reachibility of all the vertices?',
    option: [
      'transitive hull',
      'safest path',
      'minimum distance',
  ...
  {
    id: '52',
    description: 'Why graph traversal is difficult than tree traversal ',
    option: [
      'because tree have root',
      'because tree is binary',
      'because tree is undefined',
      'all of these',
    ],
  ...
  {
    id: '53',
    description: 'How quick sort partition an array ?',
    option: [
      'double element',
      'pivot element',
      'couple element',
  ...
  {
    id: '54',
    description: 'We use a circular linked list for stack as well as for …',
    option: ['binary tree', 'queue', 'heap', 'array'],
    answer: 'queue',
    tags: ['linked list', 'queue', 'circular linked list', 'stack', 'medium'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link: 'https://t4tutorials.com/graph-algorithms-solved-mcqs-with-answers/',
  },
  {
    id: '55',
    description:
      'What is the result if total time is bound of in prim’s algorithm?',
    option: ['O(m+n logn)', 'O(m logn)', 'O(nlogn)', 'none of these'],
    answer: 'O(m+n logn)',
  ...
  },
  {
    ...
    tags: ['sorting', 'topological sort', 'medium'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link:
      'http://www.allindiaexams.in/engineering/cse/data-structure-mcq/graph/2',
  },
  {
    id: '57',
    description:
  ...
  {
    id: '60',
    description: 'What is the complexity of adding an element to the heap.',
    option: ['O(log n)', 'O(h)', 'O(log n) & O(h)', 'O(n)'],
    answer: 'O(log n) & O(h)',
  ...
  {
    id: '61',
    description: 'Heap can be used as ________________',
    option: [
      'Priority queue',
      'Stack',
    ...
    tags: ['heap', 'priority queue', 'tree', 'queue', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link: 'https://www.sanfoundry.com/data-structure-questions-answers-heap/',
  },
  {
    ...
    option: ['O(n*n*logn)', 'O(n*logn)', 'O(n*n)', 'O(n *logn *logn)'],
    answer: 'O(n*logn)',
    tags: ['heap', 'tree', 'hard'],
    total_submission: 0,
    correct_submission: 0,
  ...
  {
    id: '63',
    description: ' ___________ is a self-adjusting version of a leftist heap',
    option: ['Rightist heap', 'Skew heap', 'd-heap', 'Binary heap'],
    answer: 'Skew heap',
    tags: ['heap', 'tree', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/skew-heap-multiple-choice-questions-answers-mcqs/',
  },
  {
    id: '64',
    description:
  ...
  {
    id: '65',
    description: 'What is the fundamental operation performed in skew heaps?',
    option: ['intersection', 'difference', 'merging', 'sorting'],
    answer: 'merging',
    tags: ['heap', 'tree', 'easy'],
    total_submission: 0,
    correct_submission: 0,
  ...
  {
    id: '66',
    description: 'How many types of the merge are available in skew heaps?',
    option: ['1', '2', '3', '4'],
    answer: '2',
    tags: ['heap', 'tree', 'easy'],
    total_submission: 0,
  ...
  {
    id: '67',
    description: 'Descending priority queue can be implemented using ______',
    option: ['max heap', 'min heap', 'min-max heap', 'trie'],
    answer: 'max heap',
    tags: ['heap', 'tree', 'priority queue', 'medium'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link:
      'https://www.sanfoundry.com/min-max-heap-multiple-choice-questions-answers-mcqs/',
  },
  {
    id: '68',
    description:
  ...
  {
    id: '70',
    description: 'Elements in an array are accessed _____________',
    option: ['randomly', 'sequentially', 'exponentially', 'logarithmically'],
    answer: 'randomly',
    tags: ['array', 'easy'],
    total_submission: 0,
    correct_submission: 0,
  ...
  {
    id: '71',
    description: 'Assuming int is of 4bytes, what is the size of int arr[15];?',
    option: ['15', '19', '11', '60'],
    answer: '60',
    tags: ['array', 'medium'],
    total_submission: 0,
  ...
  {
    id: '72',
    description: 'When does the ArrayIndexOutOfBoundsException occur?',
    option: [
      'Compile-time',
      'Run-time',
      'Not an error',
  ...
  },
  {
    ...
    option: ['Linked List', 'Stack', 'Queue', 'Tree'],
    answer: 'Stack',
    tags: ['stack', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/data-structure-interview-questions-answers/',
  },
  {
    id: '75',
    description: 'The postfix form of the expression (A+ B)*(C*D- E)*F / G is?',
    option: [
      'AB+ CD*E – FG /**',
      'AB + CD* E – F **G /',
      'AB + CD* E – *F *G /',
  ...
  {
    id: '76',
    description: 'The postfix form of A*B+C/D is?',
    option: ['*AB/CD+', 'AB*CD/+', 'A*BC+/D', 'ABCD+/*'],
    answer: 'AB*CD/+',
    tags: ['stack', 'hard'],
    total_submission: 0,
    correct_submission: 0,
  ...
  },
  {
    ...
    difficulty: 1,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-experienced/',
  },
  {
    id: '80',
    description:
    ...
    tags: ['circular linked list', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
  ...
  },
  {
    ...
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-double-ended-queue/',
  },
  {
    id: '84',
    description: 'What are the applications of dequeue?',
    option: [
  ...
  },
  {
    ...
    answer: 'O(n)',
    tags: ['dequeue', 'linked list', 'medium'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link:
  ...
  },
  {
    ...
    difficulty: 2,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-queue-using-stacks/',
  },
  {
    id: '87',
    description:
    ...
    option: ['Push', 'Pop', 'Enqueue', 'Returntop'],
    answer: 'Enqueue',
    tags: ['stack', 'queue', 'hard'],
    total_submission: 0,
    correct_submission: 0,
  ...
  },
  {
    ...
    difficulty: 1,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-stack-using-queues/',
  },
  {
    id: '89',
    description: 'How will you implement dynamic arrays in Java?',
    option: ['Set', 'Map', 'HashMap', 'List'],
    answer: 'List',
    tags: ['array', 'medium'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 1,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-dynamic-array/',
  },
  {
    id: '90',
    description: 'Which of the following is a disadvantage of dynamic arrays?',
    option: [
  ...
  },
  {
    ...
    difficulty: 0,
    link:
      'https://mcqslearn.com/faqs/data-structures/divide-and-conquer-exam-questions-and-answers.php',
  },
  {
    id: '93',
    description: 'Kruskal’s algorithm is used to ______',
    option: [
    ...
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/kruskals-algorithm-multiple-choice-questions-answers-mcqs/',
  },
  {
    id: '94',
    description:
  ...
  {
    id: '95',
    description: 'The Bellmann Ford algorithm returns _______ value.',
    option: ['Boolean', 'Integer', 'String', 'Double'],
    answer: 'Boolean',
    ...
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/bellman-ford-algorithm-multiple-choice-questions-answers-mcqs/',
  },
  {
    id: '96',
    description: 'What is the running time of Bellmann Ford Algorithm?',
    option: ['O(V)', 'O(V2)', 'O(ElogV)', 'O(VE)'],
    answer: 'O(VE)',
    tags: ['bellmann', 'graph', 'easy'],
    total_submission: 0,
    correct_submission: 0,
  ...
  {
    id: '97',
    description: 'What is the basic principle behind Bellmann Ford Algorithm?',
    option: ['Interpolation', 'Extrapolation', 'Regression', 'Relaxation'],
    answer: 'Relaxation',
  ...
  {
    id: '98',
    description: 'When the Breadth First Search of a graph is unique?',
    option: [
    ...
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-breadth-first-search/',
  },
  {
    id: '99',
    description: 'In BFS, how many times a node is visited?',
    option: [
      'Once',
      'Twice',
  ...
  },
  {
    ...
    option: ['Linked List', 'Tree', 'Graph with back edges', 'Array'],
    answer: 'Tree',
    tags: ['dfs', 'graph', 'easy'],
    total_submission: 0,
    correct_submission: 0,
    difficulty: 0,
    link:
      'https://www.sanfoundry.com/data-structure-questions-answers-depth-first-search/',
  },
]
