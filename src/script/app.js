...
document
  .querySelector('#bidirectional-bfs')
  .addEventListener('click', () => makeChoice('Bidirectional BFS'))
document
  .querySelector('#bidirectional-greedy-bfs')
  .addEventListener('click', () =>
    makeChoice('Bidirectional Greedy Best First'),
  )
document
...
function visualize() {
  ...
  switch (running) {
    ...
    case 'Bidirectional BFS':
      executeBidrectionalBFS()
      break
    case 'Bidirectional Greedy Best First':
      executeBidrectionalGreedyBFS()
      break
...
function visualizeRT() {
  switch (running) {
    ...
    case 'Bidirectional A*':
      ...
      break
    case 'Bidirectional BFS':
      bidirectionalBFSRT(nodes, startNode, endNode)
      break
    case 'Bidirectional Greedy Best First':
      bidirectionalGreedyBFSRT(nodes, startNode, endNode)
      break
    case 'Bidirectional Dijkstra (UCS)':
